...
local hash = loadstring(downloadFile('FlowVape/libraries/hash.lua'), 'hash')()
local prediction = loadstring(downloadFile('FlowVape/libraries/prediction.lua'), 'prediction')()
entitylib = loadstring(downloadFile('FlowVape/libraries/entity.lua'), 'entitylibrary')()
local whitelist = {
	alreadychecked = {},
	customtags = {},
...
run(function()
	...
	function whitelist:update(first)
		...
		if not first or whitelist.textdata ~= whitelist.olddata then
			if not first then
				whitelist.olddata = isfile('FlowVape/profiles/whitelist.json') and readfile('FlowVape/profiles/whitelist.json') or nil
			end
			...
			if whitelist.textdata ~= whitelist.olddata then
				...
				pcall(function()
					writefile('FlowVape/profiles/whitelist.json', whitelist.textdata)
				end)
			end
...
run(function()
	...
	local function Added(ent)
		...
		arrow.Visible = false
		arrow.Image = getcustomasset('FlowVape/assets/new/arrowmodule.png')
...
run(function()
	...
	Radar = vape:CreateOverlay({
		Name = 'Radar',
		Icon = getcustomasset('FlowVape/assets/new/radaricon.png'),
