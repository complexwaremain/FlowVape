--This watermark is used to delete the file if its cached, remove it to make the file persist after vape updates. NO SKIDDING
...
run(function()
	...
	InfiniteJump = vape.Categories.World:CreateModule({
		Name = 'InfiniteJump',
